...
func (r ApiGetIndexInfoRequest) IndexOperationRequest(indexOperationRequest IndexOperationRequest) ApiGetIndexInfoRequest {
	r.indexOperationRequest = &indexOperationRequest
	return r
}

func (r ApiGetIndexInfoRequest) Execute() (*IndexInfoResponseModel, *http.Response, error) {
	return r.ApiService.GetIndexInfoExecute(r)
}

/*
GetIndexInfo Get detailed information about an encrypted index

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetIndexInfoRequest
*/
func (a *DefaultAPIService) GetIndexInfo(ctx context.Context) ApiGetIndexInfoRequest {
	return ApiGetIndexInfoRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DefaultAPIService) GetIndexInfoExecute(r ApiGetIndexInfoRequest) (*IndexInfoResponseModel, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.GetIndexInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/indexes/describe"
