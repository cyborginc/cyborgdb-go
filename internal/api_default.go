...
// Index KEK (hex) for SDK-supplied indexes; omit for KMS-backed indexes.
func (r ApiDeleteUserV1IndexesIndexNameUsersUserIdDeleteRequest) IndexKey(indexKey string) ApiDeleteUserV1IndexesIndexNameUsersUserIdDeleteRequest {
	r.indexKey = &indexKey
	return r
}
...
func (a *DefaultAPIService) DeleteUserV1IndexesIndexNameUsersUserIdDeleteExecute(r ApiDeleteUserV1IndexesIndexNameUsersUserIdDeleteRequest) (*http.Response, error) {
	...
	if r.indexKey != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "index_key", r.indexKey, "form", "")
	}
	// to determine the Content-Type header
...
// Index KEK (hex) for SDK-supplied indexes; omit for KMS-backed indexes.
func (r ApiListUsersV1IndexesIndexNameUsersGetRequest) IndexKey(indexKey string) ApiListUsersV1IndexesIndexNameUsersGetRequest {
	r.indexKey = &indexKey
	return r
}
