...
// ListUsersResponse Response model for listing an index's users.  Attributes:     users (List[UserInfo]): The users scoped to the index.
...
func NewListUsersResponse(users []UserInfo) *ListUsersResponse {
...
func (o *ListUsersResponse) GetUsers() []UserInfo {
	if o == nil {
		var ret []UserInfo
		return ret
	}
...
func (o *ListUsersResponse) GetUsersOk() ([]UserInfo, bool) {
	if o == nil {
		return nil, false
	}
	return o.Users, true
...
func (o *ListUsersResponse) SetUsers(v []UserInfo) {
	o.Users = v
}
