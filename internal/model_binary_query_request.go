...
func NewBinaryQueryRequest(indexName string, batch BinaryQueryBatch) *BinaryQueryRequest {
...
func (o *BinaryQueryRequest) HasIndexKey() bool {
...
func (o *BinaryQueryRequest) GetRerankMult() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BinaryQueryRequest) GetRerankMultOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BinaryQueryRequest) HasRerankMult() bool {
